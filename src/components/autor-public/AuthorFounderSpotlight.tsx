...
const FOUNDER_SLUG = "pedro-garcia-martinez";

export function AuthorFounderSpotlight() {
  const profile = getAuthorProfileBySlug(FOUNDER_SLUG);
  if (!profile) return null;

  return (
    <section className="overflow-hidden rounded-2xl border border-amber-900/10 bg-white shadow-editorial">
