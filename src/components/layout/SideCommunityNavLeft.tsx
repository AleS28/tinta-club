...
export function SideCommunityNavLeft() {
  return (
    <aside
      className="side-community-nav fixed left-3 top-1/2 z-40 hidden -translate-y-1/2 flex-row items-center gap-3 xl:flex print:hidden"
    ...
    >
      <div className="flex flex-row items-center gap-3 rounded-2xl border border-[#D27C5A]/30 bg-[#FCF9F5]/80 p-3 shadow-2xl backdrop-blur-md">
        ...
        <nav className="flex max-w-[2.5rem] flex-col items-center gap-3 overflow-hidden" aria-label="Redes sociales">
